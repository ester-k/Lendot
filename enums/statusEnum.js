const LoanStatusEnum = Object.freeze({
    //loan
    "Offers In Progress": { controller: "View Actions", action: { func: "navigateAction", prop: { route: "/loanerPanel/actions" } }, bgcolor: "#FDE8EE", color: "#EC255A" },
    ...
    "Offers Available": { controller: "View Offers", action: { func: "navigateAction", prop: { route: "/loanerPanel/offers" } }, bgcolor: "#F8B0C3", color: "#EC255A", icon: "accept_offer.svg" },
    ...
    //offers
    "Offers to Accept": { controller: "Accept Offer", action: { func: "navigateAction", prop: { route: "/loanerPanel/offers" } }, icon: "accept_offer.svg" },
